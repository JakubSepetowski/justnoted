...
export const MyProfile = () => {
	...
	const [imageUpload, setimageUpload] = useState<FileList[0] | null>(null);
			...
			<div className='mt-4 w-full h-auto p-2 border rounded-lg flex flex-col justify-center items-center md:flex-row '>
				<div className='relative'>
					...
					<label
						htmlFor='file'
						role='button'
						className='absolute bottom-2 right-0  bg-white shadow-md w-8 h-8  rounded-full flex justify-center items-center '>
